...
import rpg.items.armor.pk.PKTrainingArmor;
...
public class PKArmor {
	...
	public static void load(Configuration config) {
		helmetTrainingID = config.get(Configuration.CATEGORY_ITEM, "Training Helmet ID", 1009).getInt();
		cuirassTrainingID = config.get(Configuration.CATEGORY_ITEM, "Training Cuirass ID", 1010).getInt();
		greavesTrainingID = config.get(Configuration.CATEGORY_ITEM, "Training Greaves ID", 1011).getInt();
		sabatonsTrainingID = config.get(Configuration.CATEGORY_ITEM, "Training Sabatons ID", 1012).getInt();
