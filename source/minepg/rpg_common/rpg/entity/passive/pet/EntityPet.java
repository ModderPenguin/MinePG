...
public class EntityPet extends EntityTameable {
    ...
    /**
     * The current amount of experience in the pet's
     * experience bar.
     */
    ...
    /**
     * Returns true if the newer Entity AI code should be
     * run
     */
    @Override
    ...
    /**
     * main AI tick function, replaces
    ...
    public void addExperience(int par1) {
        ...
        for (this.experienceTotal += par1; this.experience >= 1.0F; this.experience /= this.xpBarCap()) {
    ...
    /**
     * This method returns the cap amount of experience that
     * the experience bar can hold. With each level, the
     * experience cap on the player's experience bar is
     * raised by 10.
     */
    public int xpBarCap() {
        return this.experienceLevel >= 30 ? 62 + (this.experienceLevel - 30) * 7 : (this.experienceLevel >= 15 ? 17 + (this.experienceLevel - 15) * 3
                : 17);
    }

    /**
     * Called frequently so the entity can update its state
     * every tick as required. For example, zombies and
     * skeletons use this to react to sunlight and start to
     * burn.
     */
    @Override
