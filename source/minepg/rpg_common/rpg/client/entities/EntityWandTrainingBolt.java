...
public class EntityWandTrainingBolt extends EntityThrowable implements
        IProjectile {
    ...
    public EntityWandTrainingBolt(World par1World) {
        super(par1World);
        setThrowableHeading(this.motionX, this.motionY, this.motionZ, 3.0F,
                1.0F);
    }

    public EntityWandTrainingBolt(World par1World, double par2, double par4,
            double par6) {
