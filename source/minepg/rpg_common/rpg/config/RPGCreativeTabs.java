...
public class RPGCreativeTabs {
    ...
    public static final CreativeTabs tabPetItems = new CreativeTabPetItems("petItems");

    public static void addTabNames() {
        LanguageRegistry.instance().addStringLocalization("itemGroup.archerItems", "en_US", "Archer Items");
        LanguageRegistry.instance().addStringLocalization("itemGroup.mageItems", "en_US", "Mage Items");
        LanguageRegistry.instance().addStringLocalization("itemGroup.warriorItems", "en_US", "Warrior Items");
        LanguageRegistry.instance().addStringLocalization("itemGroup.petItems", "en_US", "Pet Items");
    }
}
