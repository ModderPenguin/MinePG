...
public class ArmorMage extends ItemArmor implements IArmorTextureProvider {

    public ArmorMage(int itemid, EnumArmorMaterial material, int par3, int par4, String name) {
    ...
    public void addInformation(ItemStack par1ItemStack, EntityPlayer player, List par3List, boolean par4) {
        ...
        if (PlayerInfoFake.getPlayersClass().equals("Mage") && player.experienceLevel >= 1) {
            ...
            par3List.add("Class: \u00a74Mage, \u00a7AAlchemist");
            par3List.add("Level: \u00a741");
        } else if ((!PlayerInfoFake.getPlayersClass().equals("Mage") || !PlayerInfoFake.getPlayersClass().equals("Alchemist"))
    ...
    public String getArmorTextureFile(ItemStack itemstack) {
        if (itemstack.itemID == MageArmor.hatTraining.itemID || itemstack.itemID == MageArmor.robeTraining.itemID
