...
public class ArcherTrainingArmor extends ItemArmor implements IArmorTextureProvider {

    public ArcherTrainingArmor(int itemid, EnumArmorMaterial trainingarmor, int par3, int par4, String name) {
    ...
    public void addInformation(ItemStack par1ItemStack, EntityPlayer player, List par3List, boolean par4) {
        ...
        if (PlayerInfoFake.getPlayersClass().equals("Archer") && player.experienceLevel >= 1) {
            ...
            par3List.add("Class: \u00a74Archer, \u00a7ABerserker");
            par3List.add("Level: \u00a741");
        } else if ((!PlayerInfoFake.getPlayersClass().equals("Archer") || !PlayerInfoFake.getPlayersClass().equals("Berserker")) && player.experienceLevel == 1) {
