...
public class WarriorTrainingArmor extends ItemArmor implements IArmorTextureProvider {

    public WarriorTrainingArmor(int itemid, EnumArmorMaterial material, int par3, int par4, String name) {
    ...
    public void addInformation(ItemStack par1ItemStack, EntityPlayer player, List par3List, boolean par4) {
        ...
        if (PlayerInfoFake.getPlayersClass().equals("Warrior") && player.experienceLevel >= 1) {
            ...
            par3List.add("        \u00a74Paladin, \u00a74Angel");
            par3List.add("Level: \u00a741");
        } else if ((!PlayerInfoFake.getPlayersClass().equals("Warrior") || !PlayerInfoFake.getPlayersClass().equals("Knight") || !PlayerInfoFake.getPlayersClass().equals("Paladin") || !PlayerInfoFake
