...
public class ItemRPGArmor extends RPGItem {
    ...
    public ItemRPGArmor(int par1, EnumArmorMaterial par2EnumArmorMaterial,
            int par3, int par4, String name) {
        super(par1, name);
        this.material = par2EnumArmorMaterial;
        this.armorType = par4;
        this.renderIndex = par3;
        this.damageReduceAmount = par2EnumArmorMaterial
    ...
    public Icon getIconFromDamageForRenderPass(int par1, int par2) {
        return par2 == 1 ? this.field_94605_cw : super
