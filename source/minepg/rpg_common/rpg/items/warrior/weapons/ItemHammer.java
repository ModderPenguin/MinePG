...
public class ItemHammer extends RPGItem {

    private int weaponDamage;
    private final EnumHammerMaterial toolMaterial;
    private final int healAmount;

    public ItemHammer(int id, EnumHammerMaterial material, int healAmount, String name) {
        super(id, name);
    ...
    public void addInformation(ItemStack par1ItemStack, EntityPlayer player, List par3List, boolean par4) {
        ...
        } else if ((PlayerInfoFake.getPlayersClass().equals("Paladin") || PlayerInfoFake.getPlayersClass().equals("Warrior"))
