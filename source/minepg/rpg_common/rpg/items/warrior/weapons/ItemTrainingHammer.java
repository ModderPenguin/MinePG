...
public class ItemTrainingHammer extends ItemRPGHammer {
	...
	public ItemTrainingHammer(int id, EnumRPGHammerMaterial material, int healAmount, String textureFileName) {
    ...
    public void addInformation(ItemStack par1ItemStack, EntityPlayer player, List par3List, boolean par4) {
        ...
        if((PlayerInfoFake.getPlayersClass() == "Paladin" || PlayerInfoFake.getPlayersClass() == "Warrior") && player.experienceLevel >= 1) {
            par3List.add("Class: ¤APaladin");
            par3List.add("Level: ¤A1");
        } else if((PlayerInfoFake.getPlayersClass() == "Paladin" || PlayerInfoFake.getPlayersClass() == "Warrior") && player.experienceLevel != 1) {
            par3List.add("Class: ¤APaladin");
