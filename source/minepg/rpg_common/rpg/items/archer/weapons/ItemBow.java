...
public class ItemBow extends RPGItem {

    private EnumBowMaterial bowMaterial;

    public ItemBow(int par1, EnumBowMaterial par2EnumBowMaterial, String name) {
        super(par1, name);
        this.maxStackSize = 1;
        this.bowMaterial = par2EnumBowMaterial;
        this.setMaxDamage(par2EnumBowMaterial.getMaxUses());
    }
     ...
     */
    public String getBowMaterialName() {
        return this.bowMaterial.toString();
    }
