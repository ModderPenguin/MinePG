...
import rpg.enums.weapons.EnumWandMaterial;
...
public class ItemWand extends RPGItem {

    private int weaponDamage;
    private final EnumWandMaterial toolMaterial;

    public ItemWand(int id, EnumWandMaterial material, String name) {
        super(id, name);
    ...
    public void addInformation(ItemStack par1ItemStack, EntityPlayer player, List par3List, boolean par4) {
        ...
        } else if ((PlayerInfoFake.getPlayersClass().equals("Sorcerer") || PlayerInfoFake.getPlayersClass().equals("Mage"))
